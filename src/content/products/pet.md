...
it:
  ...
  indications:
    ...
    - "Indicato nel post-chirurgico e nelle piaghe da decubito ulcerose, anche in animali diabetici, irritazioni cutanee, psoriasi, dermatiti e manifestazioni comportanti rossore e abrasioni"
    - "Punture di insetti o pruriti, escoriazioni della pelle, piaghe interdigitali, piaghe da leccamento, ulcerazioni, piodermiti"
    - "Non tossico all'ingestione: applicabile su lesioni traumatiche del cavo orale, lesioni ulcerose delle mucose (bocca, gengive, ano) e nel condotto auricolare"
  properties: |
    Gel protettivo e cicatrizzante con cellule staminali vegetali ed oli essenziali. Associando i differenti principi attivi presenti negli oli essenziali con componenti antisettici e rigeneranti, e con l'attività citoprotettiva delle cellule staminali di gardenia, si espleta una potente azione cicatrizzante, importante nel favorire la sana cicatrizzazione delle ferite limitando al contempo il rischio di infezioni batteriche. L'uso topico consente di ottimizzare l'attività in loco riducendo gli effetti collaterali sistemici.
  phyto: |
...
en:
  ...
  indications:
    ...
    - "Indicated after surgery and for ulcerative pressure sores, also in diabetic animals, skin irritations, psoriasis, dermatitis and manifestations involving redness and abrasions"
    - "Insect bites or itching, skin grazes, interdigital sores, lick sores, ulcerations, pyoderma"
    - "Non-toxic if ingested: can be applied to traumatic lesions of the oral cavity, ulcerative mucosal lesions (mouth, gums, anus) and in the ear canal"
  properties: |
    A protective and cicatrizing gel with plant stem cells and essential oils. By associating the various active ingredients in the essential oils with antiseptic and regenerative components, and the cytoprotective activity of gardenia stem cells, a powerful cicatrizing action is performed, important in promoting the healthy healing of wounds while limiting the risk of bacterial infections. Topical use optimises on-site activity, reducing systemic side effects.
  phyto: |
